...
VS_OUTPUT_FONT vs_font_with_skin(float4 vPosition : POSITION, float4 vColor : COLOR, float2 tc : TEXCOORD0, float4 vBlendWeights : BLENDWEIGHT, float4 vBlendIndices : BLENDINDICES)
{
	VS_OUTPUT_FONT Out;
...
VertexShader vs_font_skin_compiled_2_0 = compile vs_2_0 vs_font_with_skin();
...
PS_OUTPUT ps_main_no_shadow_multitex(VS_OUTPUT_FONT_X In) 
{ 
	PS_OUTPUT Output;
	
	float4 tex_col2 = tex2D(Diffuse2Sampler, In.Tex0 * uv_2_scale);
	
	INPUT_TEX_GAMMA(tex_col2);
	
	Output.RGBColor = tex_col2;
...
technique simple_shading_with_skin //Uses gamma
{
	pass P0
	{
		VertexShader = vs_font_skin_compiled_2_0;
		PixelShader = compile ps_2_0 ps_main_no_shadow();
	}
}
technique simple_shading_multitex //Uses gamma
{
	pass P0
	{
		VertexShader = vs_font_compiled_2_0;
		PixelShader = compile ps_2_0 ps_main_no_shadow_multitex();
	}
}
...
technique simple_shading_no_filter_with_skin //Uses gamma
{
	pass P0
	{
		VertexShader = vs_font_skin_compiled_2_0;
...
PS_OUTPUT ps_main_multitex(VS_OUTPUT In, uniform const int PcfMode)
{
	PS_OUTPUT Output;
	...
	Output.RGBColor = tex_col2;
	Output.RGBColor.rgb *= ((In.Color.rgb + In.SunLight));
...
technique diffuse_multitex
{
	pass P0
	{
		VertexShader = vs_main_compiled_PCF_NONE_true;
		PixelShader = compile ps_2_0 ps_main_multitex(PCF_NONE);
	}
}
...
/* 	#ifndef USE_LIGHTING_PASS
	...
	//apply material color
	//	Out.Color = min(1, float4(vMaterialColor.x, vMaterialColor.y, vMaterialColor.z, 1.0f) * vColor * diffuse_light);
...
PS_OUTPUT ps_hair(VS_OUTPUT_SIMPLE_HAIR In, uniform const int PcfMode, uniform const bool no_blend = false)
{
  ...
  if (!no_blend)
  {
	...
	final_col = tex1_col * float4(vMaterialColor.x, vMaterialColor.y, vMaterialColor.z, 1.0f);
	if (!no_blend)
  {
    half alpha = saturate(((2.0h * vMaterialColor.a ) + tex2_col.a) - 1.9h);
    final_col.rgb *= (1.0h - alpha);
    final_col.rgb += tex2_col.rgb * alpha;
	}
  
	//    tex_col = tex2_col * vMaterialColor.a + tex1_col * (1.0f - vMaterialColor.a);
...
PS_OUTPUT ps_hair_aniso(VS_OUTPUT_HAIR In, uniform const int PcfMode, uniform const bool no_blend = false)
{
	...
	//vMaterialColor.a -> age slider 0..1
	//vMaterialColor.rgb -> hair color
  ...
  {
    tex2_col = tex2D(Diffuse2Sampler, In.Tex0);
    alpha = saturate(((2.0h * vMaterialColor.a ) + tex2_col.a) - 1.9h);
  }
...
technique face_shader_high
{
	pass P0
	{
		VertexShader = compile vs_2_0 vs_main_standart_face_mod(PCF_NONE, true, false);
...
technique face_shader_high_SHDW
{
	pass P0
	{
		VertexShader = compile vs_2_0 vs_main_standart_face_mod(PCF_DEFAULT, true, false);
...
technique face_shader_high_SHDWNVIDIA
{
	pass P0
	{
		VertexShader = compile vs_2_a vs_main_standart_face_mod(PCF_NVIDIA, true, false);
		PixelShader = compile ps_2_a ps_main_standart_face_mod(PCF_NVIDIA, true, false);
	}
}
technique face_shader_skin_high
{
	pass P0
	{
		VertexShader = compile vs_2_0 vs_main_standart_face_mod(PCF_NONE, true, true);
		PixelShader = compile ps_2_0 ps_main_standart_face_mod(PCF_NONE, true, false);
	}
}
technique face_shader_skin_high_SHDW
{
	pass P0
	{
		VertexShader = compile vs_2_0 vs_main_standart_face_mod(PCF_DEFAULT, true, true);
		PixelShader = compile ps_2_0 ps_main_standart_face_mod(PCF_DEFAULT, true, false);

	}
}
technique face_shader_skin_high_SHDWNVIDIA
{
	pass P0
	{
		VertexShader = compile vs_2_a vs_main_standart_face_mod(PCF_NVIDIA, true, true);
		PixelShader = compile ps_2_a ps_main_standart_face_mod(PCF_NVIDIA, true, false);
	}
}
...
technique faceshader_skin_high_specular
{
	pass P0
	{
		VertexShader = compile vs_2_0 vs_main_standart_face_mod(PCF_NONE, true, true);
...
technique faceshader_skin_high_specular_SHDW
{
	pass P0
	{
		VertexShader = compile vs_2_0 vs_main_standart_face_mod(PCF_DEFAULT, true, true);
...
technique faceshader_skin_high_specular_SHDWNVIDIA
{
	pass P0
	{
		VertexShader = compile vs_2_a vs_main_standart_face_mod(PCF_NVIDIA, true, true);
...
technique faceshader_simple
{
	pass P0
	{
		VertexShader = compile vs_2_0 vs_main_standart_face_mod(PCF_NONE, false, false);
...
technique faceshader_simple_SHDW
{
	pass P0
	{
		VertexShader = compile vs_2_0 vs_main_standart_face_mod(PCF_DEFAULT, false, false);
...
technique faceshader_simple_SHDWNVIDIA
{
	pass P0
	{
		VertexShader = compile vs_2_a vs_main_standart_face_mod(PCF_NVIDIA, false, false);
		PixelShader = compile ps_2_a ps_main_standart_face_mod(PCF_NVIDIA, false, false);
	}
}
technique faceshader_skin_simple
{
	pass P0
	{
		VertexShader = compile vs_2_0 vs_main_standart_face_mod(PCF_NONE, false, true);
		PixelShader = compile ps_2_0 ps_main_standart_face_mod(PCF_NONE, false, false);
	}
}
technique faceshader_skin_simple_SHDW
{
	pass P0
	{
		VertexShader = compile vs_2_0 vs_main_standart_face_mod(PCF_DEFAULT, false, true);
		PixelShader = compile ps_2_0 ps_main_standart_face_mod(PCF_DEFAULT, false, false);

	}
}
technique faceshader_skin_simple_SHDWNVIDIA
{
	pass P0
	{
		VertexShader = compile vs_2_a vs_main_standart_face_mod(PCF_NVIDIA, false, true);
		PixelShader = compile ps_2_a ps_main_standart_face_mod(PCF_NVIDIA, false, false);
	}
}
